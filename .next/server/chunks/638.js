        ...
        var l = k.selectors = {
            ...
            filter: {
                PSEUDO: function(a, b, c, d) {
                    ...
                    if (e === "contains") return (a.textContent || a.innerText || k.getText([
                        a
                    ]) || "").indexOf(b[3]) >= 0;
                    if (e === "not") {
                        var g = b[3];
            ...
            f.ajax({
                ...
                complete: function(a, b, c) {
                    c = a.responseText, a.isResolved() && (a.done(function(a) {
                        c = a;
                    }), i.html(g ? f("<div>").append(c.replace(bM, "")).find(g) : c)), d && i.each(d, [
                        c,
                        b,
                        a
                    ]);
        ...
        animate: function(a, b, c, d) {
            ...
            return this[e.queue === !1 ? "each" : "queue"](function() {
                ...
                for(i in a){
                    ...
                    ], f.css(this, "display") === "inline" && f.css(this, "float") === "none" && (f.support.inlineBlockNeedsLayout ? (j = ct(this.nodeName), j === "inline" ? this.style.display = "inline-block" : (this.style.display = "inline", this.style.zoom = 1)) : this.style.display = "inline-block")), b.animatedProperties[g] = f.isArray(h) ? h[1] : b.specialEasing && b.specialEasing[g] || b.easing || "swing";
                }
